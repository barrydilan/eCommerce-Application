...
export default function ChangePassword(props: { currPassword: string }) {
  const { currPassword } = props;
  ...
  }, [values, errors, touched, setIsNewPassBlocked, setIsSaveBlocked, currPassword]);
