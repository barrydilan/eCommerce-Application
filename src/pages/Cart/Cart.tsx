...
"
    >
      ...
      <div className="relative flex items-center gap-x-4 border-b-1 border-text-grey/40 pb-4 md:gap-x-1">
        <div className="flex items-center gap-x-4 md:max-w-[35%] md:gap-x-2">
          <img className="h-full w-full object-cover" src="src/assets/img/cart-img.png" alt="" />
        </div>
        <div className="flex w-3/4 flex-col gap-y-10 md:gap-y-7 lg:gap-y-10">
          <h3 className="text-lg sm:text-xl md:text-xs lg:text-base">Vegan Meal</h3>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-x-3 md:pl-1">
              <div className="rounded-full bg-accent-lightest px-2 text-xl text-accent sm:text-xl md:px-1 md:text-sm lg:px-2 lg:text-xl">
                -
              </div>
